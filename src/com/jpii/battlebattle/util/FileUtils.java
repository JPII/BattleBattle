...
public class FileUtils {
	...
	public static File getSavingDirectory() {
		if (workDir == null)
			workDir = getSavingDirectory("battlebattle");
		return workDir;
	}
	...
	public static URL getResourcePath(String s){
		return FileUtils.class.getResource("/com/jpii/battlebattle/res/" + s);
	}
	...
	public static BufferedImage getImage(String s){
		...
		try {
			i = ImageIO.read(FileUtils.class.getResource("/com/jpii/battlebattle/res/"+s));
		} catch (Throwable e) {
